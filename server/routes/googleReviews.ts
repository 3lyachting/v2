...
const MANUAL_VERIFIED_REVIEWS = [
  ...
  {
    authorName: "Bernard Blanc",
    rating: 5,
    text: "Quinzaine de reve sur Sabine Sailing. Skipper competent, attentif au bien-etre de tous, bateau confortable et tres bien equipe.",
    time: 0,
  },
  {
    authorName: "Jules Leydet",
    rating: 5,
    text: "Super experience, le reve.",
    time: 0,
  },
];
  ...
  try {
    ...
    if (!apiKey) {
      return res.json({
        ...
        name: "Sabine Sailing",
        rating: 5,
        userRatingsTotal: MANUAL_VERIFIED_REVIEWS.length,
        url: DEFAULT_PLACE_URL,
        reviews: MANUAL_VERIFIED_REVIEWS,
